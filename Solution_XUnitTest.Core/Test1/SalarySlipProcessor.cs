...
namespace Solution_XUnitTest.Core.Test1
{
    public class SalarySlipProcessor
    {
        ...
        public decimal CalculateDangerPay(Employee employee)
        {
            ...
            //old version totaly coupled not good for testing
            //si ZoneService ne marche pas ma function va planter c'est pas
            //bon pour le test sur ma functon car elle depend d'un autre service

            //var zoneService = new ZoneService();
            //var isDanger =zoneService.IsDangerZone(employee.DutyStation);

            //new version loosly coupled with DIP
